...
abstract class FallingblocksSessionBindings {
    @Binds internal abstract fun bindLoader(impl: FallingBlocksPersistence): GameSnapshotLoader
    ...
    companion object {
        @Provides internal fun provideEngine(): FallingBlocksEngine = DefaultFallingBlocksEngine
