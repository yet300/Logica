# Funfolio catalog and contributor governance design

## Decision

Funfolio is a single Kotlin Multiplatform host for a curated collection of
...
sessions, low friction and offline/low-bandwidth use. Funfolio therefore keeps
...
3. Update README and contributor guidance to describe Funfolio's super-app model,
